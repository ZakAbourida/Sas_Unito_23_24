...
public class TestSheet5 {
    /**
     * OP.: ASSIGN_PORTION_IN_ASSIGNMENT
     */
    public static void main(String[] args) {
        try {
            ...
            System.out.print("Inserisci la nuova porzione: ");
            int newPortion = scanner.nextInt();
            CatERing.getInstance().getSummarySheetManager().assignPortion(newPortion, selectedAssignment);
